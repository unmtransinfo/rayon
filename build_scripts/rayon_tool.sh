...
# not to be built.
#
#./${pkg}_tool config python 3.9.6
#./${pkg}_tool config redis 6.2.5
#./${pkg}_tool config nginx 1.21.1
#./${pkg}_tool config prometheus 2.28.1
#./${pkg}_tool config alertmanager 0.22.2
#./${pkg}_tool config node_exporter 1.2.2
#./${pkg}_tool config pushgateway 1.4.1
#
...
init() {
   ...
   set_value python 3.9.6
   set_value redis 6.2.5
   set_value nginx 1.21.1
   set_value prometheus 2.28.1
   set_value alertmanager 0.22.2
   set_value node_exporter 1.2.2
   set_value pushgateway 1.4.1
...
"""
  ...
  cc="$(get_value cc)"
  make="$(get_value make)"
  commandlist="python redis nginx prometheus alertmanager node_exporter pushgateway"
