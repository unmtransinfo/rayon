...
The primary design goal for rayon was to implement best practices for:
...
implement rayon is shown below:

.. image:: rayon_processes.svg
...
* A Flask-based service process (rayon) that handles configuration and dispatching
